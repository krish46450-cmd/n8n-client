...
User has also uploaded an image (screenshot or error image).

Please respond as a helpful technical support assistant. Analyze the provided image carefully for any error messages, system issues, or relevant information. If the user is having trouble with solution steps, provide detailed guidance. If the solution didn't work, ask clarifying questions and suggest alternatives. If the issue seems too complex or you cannot help further, recommend escalation to human support.
            ...
            if image_data:
                try:
                    ...
                    try:
                        ...
                        logging.warning(f"Failed to add image to request: {str(e)}")
